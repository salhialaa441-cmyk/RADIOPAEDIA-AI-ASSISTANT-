...
import { createUnsharpMaskProgram } from '../../../src/webgl/shaders/unsharpMask';
...
describe('UnsharpMask Shader', () => {
  ...
  it('should compile unsharp mask shader successfully', () => {
    const result = createUnsharpMaskProgram(gl);

    expect(result).not.toBeNull();
    expect(result.program).toBeDefined();
  });

  it('should have strength uniform', () => {
    const result = createUnsharpMaskProgram(gl);

    expect(result.locations.strength).toBeDefined();
  });
